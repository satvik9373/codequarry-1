(() => {
    ...
    (() => {
        ...
        function O() {
            ...
            }, a.values = L, j.prototype = {
                constructor: j,
                reset: function t(e) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(S), !e)
        ...
        document.addEventListener("DOMContentLoaded", function(t) {
            ...
            function j() {
                var t;
                var e = P(S.files).reduce(function(t, e) {
                    return t + e.size
                }, 0);
        ...
        window.jQuery(document).ready(function(i) {
            ...
            t.forEach(function(t) {
                t.onclick = function() {
                    var e = et(A().mark(function t(r) {
                        var n, o, i, a, u, c, s, l;
                        return A().wrap(function t(e) {
                            while (1) switch (e.prev = e.next) {
                                case 0:
                                    r.preventDefault();
        ...
        jQuery(document).ready(function(u) {
            ...
            var o = {
                ...
                video_data: function t() {
                    var e = u("#tutor_video_tracking_information").val();
                ...
                track_player: function t() {
                    ...
                    if (typeof Plyr !== "undefined") {
                        ...
                        s.on("ended", function(t) {
                            ...
                            u.sync_time(r, n);
                            console.log(e.autoload_next_course_content, u.played_once);
                ...
                autoload_content: function t() {
                    ...
                    u.post(this.ajaxurl, r).done(function(t) {
                        console.log(t);
                ...
                enable_complete_lesson_btn: function t(e) {
                    var r = u('button[name="complete_lesson_btn"]');
                    var n = this.video_data();
                ...
                disable_complete_lesson_btn: function t() {
                    ...
                    if (i < o) {
                        var a = u('button[name="complete_lesson_btn"]');
            ...
            u(".tutorPlayer").each(function() {
                o.init(this)
            });
            u(document).on("change keyup paste", ".tutor_user_name", function() {
                u(this).val(a(u(this).val()))
            });

            function a(t) {
                return t.toString().toLowerCase().replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
            }
            u(document).on("click", ".tutor_question_cancel", function(t) {
                t.preventDefault();
                u(".tutor-add-question-wrap").toggle()
            });
            u(".tooltip-btn").on("hover", function(t) {
                u(this).toggleClass("active")
            });
            u(".tutor-course-title h4 .toggle-information-icon").on("click", function(t) {
                u(this).closest(".tutor-topics-in-single-lesson").find(".tutor-topics-summery").slideToggle();
                t.stopPropagation()
            });
            u(".tutor-course-topic.tutor-active").find(".tutor-course-lessons").slideDown();
            u(".tutor-course-title").on("click", function() {
                var t = u(this).siblings(".tutor-course-lessons");
                u(this).closest(".tutor-course-topic").toggleClass("tutor-active");
                t.slideToggle()
            });
            u(document).on("click", ".tutor-topics-title h3 .toggle-information-icon", function(t) {
                u(this).closest(".tutor-topics-in-single-lesson").find(".tutor-topics-summery").slideToggle();
                t.stopPropagation()
            });
            u(document).on("click", "[tutor-course-topics-sidebar-toggler]", function(t) {
                t.preventDefault();
                u(".tutor-course-single-content-wrapper").toggleClass("tutor-course-single-sidebar-hidden")
            });
            u("[tutor-course-topics-sidebar-offcanvas-toggler]").on("click", function(t) {
                t.preventDefault();
                u(".tutor-course-single-content-wrapper").toggleClass("tutor-course-single-sidebar-open");
                u("body").toggleClass("tutor-overflow-hidden")
            });
            u("[tutor-hide-course-single-sidebar]").on("click", function(t) {
                t.preventDefault();
                console.log("Hello");
                u(".tutor-course-single-content-wrapper").removeClass("tutor-course-single-sidebar-open");
                u("body").removeClass("tutor-overflow-hidden")
            });
            u(".tutor-tabs-btn-group a").on("click touchstart", function(t) {
                t.preventDefault();
                var e = u(this);
                var r = e.attr("href");
                u(".tutor-lesson-sidebar-tab-item").hide();
                u(r).show();
                u(".tutor-tabs-btn-group a").removeClass("active");
                e.addClass("active")
            });
            var c = u(".quiz-draggable-rand-answers").length;
            if (c) {
                u(".quiz-draggable-rand-answers").each(function() {
                    var t = u(this);
                    var e = t.height();
                    t.css({
                        height: e
            ...
            if (jQuery.datepicker) {
                u(".tutor_report_datepicker").datepicker({
                    dateFormat: "yy-mm-dd"
                })
            }
            u(document).on("submit", "#tutor-withdraw-account-set-form", function(t) {
            ...
            u(document).on("submit", "#tutor-earning-withdraw-form", function(t) {
                t.preventDefault();
                var e = u(this);
                var r = u("#tutor-earning-withdraw-btn");
                var n = u(".tutor-withdraw-form-response");
                ...
                u.ajax({
                    ...
                    success: function t(e) {
                        var r;
                        u(".tutor-earning-withdraw-form-wrap").hide();
                        if (e.success) {
                            console.log(e.data.available_balance);
                            if (e.data.available_balance !== "undefined") {
                                u(".withdraw-balance-col .available_balance").html(e.data.available_balance)
                            }
            ...
            u(document).on("click", ".tutor-dashboard-element-delete-btn", function(t) {
                t.preventDefault();
                var e = u(this).attr("data-id");
                u("#tutor-dashboard-delete-element-id").val(e)
            });
            u(document).on("submit", "#tutor-dashboard-delete-element-form", function(t) {
                t.preventDefault();
                var r = u("#tutor-dashboard-delete-element-id").val();
                var e = u(".tutor-modal-element-delete-btn");
                var n = u(this).serializeObject();
                u.ajax({
                    url: _tutorobject.ajaxurl,
                    type: "POST",
                    data: n,
                    ...
                    success: function t(e) {
                        if (e.success) {
                            u("#tutor-dashboard-" + e.data.element + "-" + r).remove()
                        }
                    },
                    complete: function t() {
                        e.removeClass("is-loading")
            ...
            u(document).on("submit", "#tutor_assignment_start_form", function(t) {
                t.preventDefault();
                var e = u(this);
                ...
                u.ajax({
                    ...
                    data: r,
                    beforeSend: function t() {
                        u("#tutor_assignment_start_btn").addClass("is-loading")
                    },
                    success: function t(e) {
                        if (e.success) {
                    ...
                    complete: function t() {
                        u("#tutor_assignment_start_btn").removeClass("is-loading")
                    }
                })
            });
            u(document).on("submit", "#tutor_assignment_submit_form", function(t) {
            ...
            u("form").on("change", ".tutor-assignment-file-upload", function() {
                u(this).siblings("label").find("span").html(u(this).val().replace(/.*(\/|\\)/, ""))
            });
            if (u(".tutor-accordion-item-header.is-active").length === 0) {
                u(".tutor-accordion-item-header").first().trigger("click")
            }
            u(".tutor-course-builder-section-title").on("click", function() {
                if (u(this).find("i").hasClass("tutor-icon-angle-up")) {
                    u(this).find("i").removeClass("tutor-icon-angle-up").addClass("tutor-icon-angle-down")
                } else {
                    u(this).find("i").removeClass("tutor-icon-angle-down").addClass("tutor-icon-angle-up")
                }
                u(this).next("div").slideToggle()
            });
            u(document).on("click", "#tutor_profile_photo_button", function(t) {
                t.preventDefault();
                u("#tutor_profile_photo_file").trigger("click")
            });
            u(document).on("change", "#tutor_profile_photo_file", function(t) {
                t.preventDefault();
                var e = this;
                if (e.files && e.files[0]) {
                    var r = new FileReader;
                    r.onload = function(t) {
                        u(".tutor-profile-photo-upload-wrap").find("img").attr("src", t.target.result)
                    };
                    r.readAsDataURL(e.files[0])
                }
            });
            u(document).on("click", ".thread-content .subject", function(t) {
                var e = u(this);
                ...
                u.ajax({
                    ...
                    data: o,
                    beforeSend: function t() {
                        u("#tutor-bp-thread-wrap").html("")
                    },
                    success: function t(e) {
                        if (e.success) {
                            u("#tutor-bp-thread-wrap").html(e.data.thread_head_html);
                            s()
                        }
                    }
                })
            ...
            function s() {
                u("ul.tutor-bp-enrolled-course-list").each(function() {
                    var t = u(this);
                    var e = t.find(" > li");
                    var n = 3;
                    if (e.length > n) {
            ...
            s();
            u(document).on("click", "a.tutor_bp_plus_courses", function(t) {
                t.preventDefault();
                var e = u(this);
            ...
            u(".tutor-dropbtn").click(function() {
                var t = u(this).parent().find(".tutor-dropdown-content");
                t.slideToggle(100)
            });
            u(document).on("click", function(t) {
                var e = u(".tutor-dropdown");
                var r = e.find(".tutor-dropdown-content");
                if (!e.is(t.target) && e.has(t.target).length === 0) {
                    r.slideUp(100)
                }
            });
            var l = u('.tutor-frontend-builder-course-price [name="tutor_course_price_type"]');
            if (l.length == 0) {
                u("#_tutor_is_course_public_meta_checkbox").show()
            } else {
                l.change(function() {
                    if (u(this).prop("checked")) {
                        var t = u(this).val() == "paid" ? "hide" : "show";
                        u("#_tutor_is_course_public_meta_checkbox")[t]()
                    }
                }).trigger("change")
            }(function(e) {
