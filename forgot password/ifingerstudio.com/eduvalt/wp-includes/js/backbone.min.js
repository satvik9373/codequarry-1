/*! This file is auto-generated */ ! function(n) {
    ...
    var o, i = t.Backbone,
        ...
        e = (h.VERSION = "1.4.1", h.$ = e, h.noConflict = function() {
        ...
        n = (e.on = function(t, e, i) {
            ...
            if (t) {
                var n = t._listenId || (t._listenId = b.uniqueId("l")),
                    ...
                    r = o = s[n],
                    s = (r || (this._listenId || (this._listenId = b.uniqueId("l")), r = o = s[n] = new g(this, t)), l(t, e, i, this));
        ...
        m = (b.extend(v.prototype, e, {
            ...
            set: function(t, e, i) {
                if (null != t) {
                    ...
                    for (s in n) e = n[s], b.isEqual(u[s], e) || h.push(s), b.isEqual(l[s], e) ? delete c[s] : c[s] = e, o ? delete u[s] : u[s] = e;
        ...
        y = (b.extend(m.prototype, e, {
            ...
            set: function(t, e) {
                if (null != t) {
                    ...
                    for (var i = !b.isArray(t), n = (t = i ? [t] : t.slice(), e.at), s = ((n = (n = null != n ? +n : n) > this.length ? this.length : n) < 0 && (n += this.length + 1), []), r = [], o = [], h = [], a = {}, u = e.add, c = e.merge, l = e.remove, d = !1, f = this.comparator && null == n && !1 !== e.sort, p = b.isString(this.comparator) ? this.comparator : null, g = 0; g < t.length; g++) {
                        var v, m = t[g],
                            _ = this.get(m);
        ...
        y = (y && (E.prototype[y] = function() {
            ...
            if (this._collection) {
                ...
                if (this._index < this._collection.length) return t = this._collection.at(this._index), this._index++, {
                    value: this._kind === I ? t : (e = this._collection.modelId(t.attributes, t.idAttribute), this._kind === k ? e : [e, t]),
                    done: !1
                };
        ...
        M = (R.started = !1, b.extend(R.prototype, e, {
            ...
            navigate: function(t, e) {
                ...
                var i = this.root,
                    i = (i = "" !== t && "?" !== t.charAt(0) ? i : i.slice(0, -1) || "/") + t,
